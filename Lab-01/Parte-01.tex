...
Como se puede ver, al poder escuchar la nota de voz más de una vez, la tasa de acierto subió bastante en comparación con la transmisión en vivo, donde no había forma de "rebobinar" si se perdía un pulso. Aun así se colaron un par de errores mínimos (una letra cambiada por otra parecida en sonido), lo cual se explica más a detalle en la siguiente sección.
